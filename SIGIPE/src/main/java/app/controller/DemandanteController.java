...
public class DemandanteController{
	...
	public ResponseEntity<String> save(@RequestBody Demandante demandante){
		try {
	...
	public ResponseEntity<String> update(@PathVariable long id,@RequestBody Demandante demandante){
		try {
