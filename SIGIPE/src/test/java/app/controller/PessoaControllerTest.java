...
public class PessoaControllerTest {
    ...
    void setup(){
        ...
        lista.add(new Pessoa(1,"João Marcelo","marcelinho12@email.com","Senha111","011.024.987-89","(88)03909-9090",5, new Grupo(), new Funcao()));
        lista.add(new Pessoa(2,"Homer","homer12@email.com","Senha121","013.014.983-84","(80)03939-9030",5, new Grupo(), new Funcao()));

        when(this.pessoaRepository.findAll()).thenReturn(lista);
        when(this.pessoaRepository.save(Mockito.any())).thenReturn(new Pessoa(3,"Bart","bart12@email.com","BArto","125.256.987-89","(89)97788-7878",6, new Grupo(), new Funcao()));
        when(this.pessoaRepository.findById(1L)).thenReturn(Optional.of(new Pessoa(4,"Lisa","lisa@email.com","Lisa12","987.256.959-98","(09)98977-9898",8, new Grupo(), new Funcao())));
    ...
    void TestMetodoSave(){
        ...
        Pessoa pessoa = new Pessoa(5,"Zé","ze@email.com","Ze1","989.989.989-98","(78)78787-7878",9, new Grupo(), new Funcao());
    ...
    void TestMetodoUpdate(){
        ...
        Pessoa pessoa = new Pessoa(6,"Marge","marge2@email.com","Senha11","115.545.789-98","(12)98742-9756",1, new Grupo(), new Funcao());
    ...
    void TestDeleteById(){
        ...
        Pessoa pessoa = new Pessoa(7,"Flanders","flanders21@email.com","Senha11","032.124.985-03","(32)12033-3654",10, new Grupo(), new Funcao());
