...
public class GrupoControllerTest {
	...
	void setup() {
		...
		when(this.grupoRepository.save(new Grupo(1, "aaa"))).thenReturn(new Grupo());
	...
	@Test
	void save200() {
		ResponseEntity<String> response = this.grupoController.save(new Grupo(1, "aaa"));
		int httpStatus = response.getStatusCode().value();
		assertEquals(200, httpStatus);
	}
	...
	@Test
	void update200() {
		ResponseEntity<String> response = this.grupoController.updade(1, new Grupo(1, "aaa"));
		assertEquals(HttpStatus.OK, response.getStatusCode());
	}
	
	@Test
	void update400() {
		ResponseEntity<String> response = this.grupoController.updade(0, new Grupo(1, "aaa"));
		assertEquals(HttpStatus.BAD_REQUEST, response.getStatusCode());
	}
	
	@Test
	void update404_1() {
		ResponseEntity<String> response = this.grupoController.updade(2, new Grupo(1, "aaa"));
